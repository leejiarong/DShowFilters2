...
{
	{&__uuidof(CFLVSplitterFilter), L"Acer FLV Splitter", MERIT_PREFERRED+1, countof(sudpPins), sudpPins},
	{&__uuidof(CFLVSourceFilter), L"Acer FLV Source", MERIT_NORMAL+1, 0, NULL},

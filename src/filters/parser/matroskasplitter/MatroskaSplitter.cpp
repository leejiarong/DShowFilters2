...
{
	{&__uuidof(CMatroskaSplitterFilter), L"Acer MKV Splitter", MERIT_NORMAL, countof(sudpPins), sudpPins},
	{&__uuidof(CMatroskaSourceFilter), L"Acer MKV Source", MERIT_NORMAL, 0, NULL},
};

...
{
	{&__uuidof(CMP4SplitterFilter), L"Acer MP4 Splitter 2", MERIT_NORMAL+3, countof(sudpPins), sudpPins},
	{&__uuidof(CMP4SourceFilter), L"Acer MP4 Source 2", MERIT_NORMAL+3, 0, NULL},

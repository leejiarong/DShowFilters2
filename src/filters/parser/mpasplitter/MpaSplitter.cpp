...
{
	{&__uuidof(CMpaSplitterFilter), L"Acer Mpeg Audio Splitter", MERIT_NORMAL+1, countof(sudpPins), sudpPins},
	{&__uuidof(CMpaSourceFilter), L"Acer Mpeg Audio Source", MERIT_NORMAL+1, 0, NULL},
};

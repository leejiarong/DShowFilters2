...
{
	{&__uuidof(CMpegSplitterFilter), L"Acer Mpeg Splitter", MERIT_UNLIKELY+1 /*MERIT_DO_NOT_USE*/, countof(sudpPins), sudpPins},
	{&__uuidof(CMpegSourceFilter), L"Acer Mpeg Source", MERIT_DO_NOT_USE, 0, NULL},
};

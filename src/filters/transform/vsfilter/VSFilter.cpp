...
BOOL CVSFilterApp::InitInstance()
{
	...
	if(nError != ERROR_SUCCESS)
		TRACE(_T("CVSFilterApp::InitInstance open reg key error [%ld]\n"), nError);
...
/*const*/ AMOVIESETUP_FILTER sudFilter[] =
{
	...
	{&__uuidof(CDirectVobSubFilter2), ACER_SUBTITLE, /*MERIT_DO_NOT_USE*/MERIT_PREFERRED+2, countof(sudpPins), sudpPins},
};
